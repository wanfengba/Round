...
?>
    ...
    <link href="<?php _getAssets('assets/typecho/write/css/joe.write.min.css') ?>" rel="stylesheet" />
    <link href="<?php _getAssets('Plugin/assets/css/joe.write.min.css'); ?>" rel="stylesheet" />
    <script>
      window.JoeConfig = {
        uploadAPI: '<?php Helper::security()->index('/action/upload'); ?>',
        emojiAPI: '<?php _getAssets('assets/typecho/write/json/emoji.json') ?>',
        expressionAPI: '<?php _getAssets('assets/typecho/write/json/expression.json') ?>',
        characterAPI: '<?php _getAssets('assets/typecho/write/json/character.json') ?>',
    ...
    <script src="<?php _getAssets('assets/js/short.min.js') ?>"></script>
<?php
  }
}
